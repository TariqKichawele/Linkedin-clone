...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
    ...
    const { mutate: acceptRequest } = useMutation({
        ...
        onError: (error) => {
            toast.error("Error accepting connection request", error.message);
        }
    });
    ...
    const { mutate: rejectRequest } = useMutation({
        ...
        onError: (error) => {
            toast.error("Error rejecting connection request", error.message);
        }
    });
    ...
    const { mutate: removeConnection } = useMutation({
        ...
        onError: (error) => {
            toast.error("Error removing connection", error.message);
        }
    });
